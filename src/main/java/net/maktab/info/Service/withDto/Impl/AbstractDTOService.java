package net.maktab.info.Service.withDto.Impl;

import net.maktab.info.Service.withDto.CommonServiceDto;

import net.maktab.info.converter.AbstractDTOConverter;
import net.maktab.info.dto.BaseDTO;
import net.maktab.info.entity.DistributedEntity;
import net.maktab.info.repository.DistributedRepository;
